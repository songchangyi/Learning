...
class DialogueManager(object):
    ...
    def create_chitchat_bot(self):
        ...
        #### YOUR CODE HERE ####
        ########################
        self.chitchat_bot = ChatBot('mybot', trainer='chatterbot.trainers.ChatterBotCorpusTrainer')
    ...
    def generate_answer(self, question):
        ...
        # Goal-oriented part:
            ...
            if tag in ['c#', 'java', 'javascript']:
                ans = """
                I see you are looking for a solution for c_pp, java or javascript. 
                However, I could not provide you that due to out of memory problem on AWS.
                I would be happy to help you on other questions like vb, python or swift.
